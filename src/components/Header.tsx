  ...
  return (
    <header className="bg-[#271637] border-b border-white/20 sticky top-0 z-50">
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" aria-label="Navegación principal">
          ...
          <div className="hidden md:flex md:items-center md:space-x-6">
            ...
            <div className="flex items-center space-x-1 text-sm">
              <button
                ...
                className={`text-white hover:text-[#e00053] focus:text-[#e00053] transition-colors font-medium ${language === 'es' ? 'underline' : ''}`}
                aria-label="Cambiar idioma a castellano"
              >
              ...
              <button
                ...
                className={`text-white hover:text-[#e00053] focus:text-[#e00053] transition-colors font-medium ${language === 'gl' ? 'underline' : ''}`}
                aria-label="Cambiar idioma a gallego"
              >
        ...
        {/* Menú móvil */}
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t bg-[#271637] border-b border-white/20">
            <div className="flex flex-col space-y-4">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="text-white hover:text-[#e00053] focus:text-[#e00053] transition-colors font-medium px-2"
